...
public class TestUniformSampling {
  public double calculateStandardDeviation(List<Integer> numbers) {
    ...
    double sumOfSquaredDifferences =
        numbers.stream().mapToDouble(num -> Math.pow(num - mean, 2)).sum();
  ...
  public void testUniformSampling() {
    EngineTestKit.engine("junit-jupiter")
        ...
        .allEvents()
        .assertThatEvents()
        .haveExactly(5000, event(test("testUniformSampling"), finishedSuccessfully()));
    Map<Integer, Integer> values =
        org.pastalab.fray.junit.internal.surw.TestUniformSampling.xValues;
  ...
  public void testUniformSamplingLeftShift() {
    EngineTestKit.engine("junit-jupiter")
        ...
        .allEvents()
        .assertThatEvents()
        .haveExactly(1000, event(test("testUniformSampling"), finishedSuccessfully()));
    Map<Integer, Integer> values =
        org.pastalab.fray.junit.internal.surw.TestUniformSamplingLeftShift.xValues;
