...
//
//  public static @NotNull @Nls String message(@NotNull @PropertyKey(resourceBundle = BUNDLE) String
// key, Object @NotNull ... params) {
//    return INSTANCE.getMessage(key, params);
//  }
//
//  public static @NotNull Supplier<@Nls String> messagePointer(@NotNull @PropertyKey(resourceBundle
// = BUNDLE) String key, Object @NotNull ... params) {
