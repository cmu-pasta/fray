...
dependencies {
    ...
    intellijPlatform {
        create(project.property("platformType")!! as String, project.property("platformVersion")!! as String)
...
intellijPlatform {
    pluginConfiguration {
        ...
        changeNotes = (project.property("pluginVersion") as String).let { pluginVersion ->
            with(changelog) {
                renderItem(
