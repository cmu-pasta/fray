...
public class Runtime {
  ...
  public static long onSemaphoreTryAcquirePermitsTimeout(
      Semaphore sem, int permits, long timeout, TimeUnit unit) {
  ...
  public static boolean onLatchAwaitTimeout(CountDownLatch latch, long timeout, TimeUnit unit)
  ...
  public static long onConditionAwaitNanos(Condition object, long nanos)
      throws InterruptedException {
    return LOCK_DELEGATE.onConditionAwaitNanos(object, nanos);
  }

  public static boolean onConditionAwaitTime(Condition object, long time, TimeUnit unit)
      throws InterruptedException {
    return LOCK_DELEGATE.onConditionAwaitTime(object, time, unit);
  }

  public static boolean onConditionAwaitUntil(Condition object, Date deadline)
      throws InterruptedException {
  ...
  public static long onStampedLockReadLockTryLockTimeout(
      StampedLock lock, long timeout, TimeUnit unit) {
    return LOCK_DELEGATE.onStampedLockReadLockTryLockTimeout(lock, timeout, unit);
  }

  public static long onStampedLockWriteLockTryLockTimeout(
      StampedLock lock, long timeout, TimeUnit unit) {
  ...
  public static long onStampedLockTryConvertToReadLockDone(
      long newStamp, StampedLock lock, long stamp) {
    return LOCK_DELEGATE.onStampedLockTryConvertToReadLockDone(newStamp, lock, stamp);
  }

  public static long onStampedLockTryConvertToWriteLockDone(
      long newStamp, StampedLock lock, long stamp) {
    return LOCK_DELEGATE.onStampedLockTryConvertToWriteLockDone(newStamp, lock, stamp);
  }

  public static long onStampedLockTryConvertToOptimisticReadLockDone(
      long newStamp, StampedLock lock, long stamp) {
  ...
  public static void onServerSocketChannelAcceptDone(
      ServerSocketChannel channel, SocketChannel client) {
